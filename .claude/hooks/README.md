...
### 7. journey-log.cjs
**Trigger:** `PostToolUse` (Bash | Write | Edit | Task)
**Comportamento:** LOGA (exit 0 sempre — nunca bloqueia)

Registra toda execução de ferramenta em `.aios/journey.log`:

```
2026-03-05T02:47:17Z | 373ed41e | Bash     | npm run build
2026-03-05T02:47:18Z | 373ed41e | Write    | src/components/Button.tsx
2026-03-05T02:47:19Z | 373ed41e | Edit     | docs/README.md
```

Implementado como parte do gap AIOX "Journey Log" (prioridade CRÍTICA).

## Manutenção

Para adicionar novo hook:

1. Criar arquivo `.claude/hooks/novo-hook.cjs` (Node.js) ou `.py` (Python)
2. Adicionar entrada em `.claude/settings.local.json`
3. Documentar neste README
4. Testar com: `echo '{...json...}' | node .claude/hooks/novo-hook.cjs`

---

*Criado: 2026-01-24*
*Atualizado: 2026-03-05 — journey-log.cjs adicionado*
